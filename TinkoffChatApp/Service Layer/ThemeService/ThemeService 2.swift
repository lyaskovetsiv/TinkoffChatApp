...
final class ThemeService: IThemeService {
	/// Главная точка доступа к классу ThemeManager
	static let shared = ThemeService(themeStorageService: UserDefaultsService.shared)
	...
	private var themeStorageService: IThemeStorageService

	// MARK: - Inits

	private init (themeStorageService: IThemeStorageService) {
	...
	public func didSelectTheme(_ theme: Theme) {
