...
final class UserInfoService: IUserInfoService {
	/// Главная точка доступа к классу UserInfoService
	static let shared = UserInfoService(userInfoStorageService: FileManagerService.shared)
	...
	private init (userInfoStorageService: IFileManagerSevice) {
